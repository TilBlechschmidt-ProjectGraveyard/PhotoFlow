...
protocol CreateViewControllerDelegate: class {
    func createViewControllerDidCancelImport(_ createViewController: ImportViewController)
    func createViewController(_ createViewController: ImportViewController, didImport assets: [PHAsset])
}
...
class ImportViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Cancel", style: .done, target: self, action: #selector(cancelTapped))
    }

    @objc func cancelTapped() {
        delegate?.createViewControllerDidCancelImport(self)
    }
...
extension ImportViewController: UICollectionViewDataSource {
